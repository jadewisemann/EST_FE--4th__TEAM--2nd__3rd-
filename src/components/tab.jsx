...
const Tab = () => {
  const buttons = ["전체","모텔","호텔/리조트","팬션/풀빌라","해외숙소"];
  ...
  return (
    <>
      <div className="flex relative items-center mt-5 mx-5">
        ...
        <button className="flex gap-x-1 items-center h-9 py-2 pl-3 flex-none border-l-1 border-neutral-300 bg -white text-xs">
